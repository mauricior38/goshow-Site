export default function Contact() {
  return (
    <section className="bg-white">
      <div className="bg-[url('https://flowbite.s3.amazonaws.com/blocks/marketing-ui/contact/laptop-human.jpg')] bg-no-repeat bg-cover bg-center bg-gray-700 bg-blend-multiply py-16 px-4 mx-auto max-w-screen text-center lg:py-16 lg:px-12 md:shadow-xl" id="contato">
