  ...
  return (
    <footer className="bg-gray-50 dark:bg-gray-800">
      <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
        ...
        <div className="justify-between items-center p-4 mx-auto mt-6 max-w-screen-md bg-gray-50 rounded-lg lg:mt-16 sm:flex dark:bg-gray-700">
          <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
            Sign up to our newsletter
          </p>
          <form action="#" className="flex mt-4 ml-0 w-full sm:mt-0 sm:ml-5">
            <div className="relative w-full">
              ...
              <input
                type="email"
                id="email-subscribe"
                className="block p-3 pl-10 w-full text-sm text-gray-900 bg-white rounded-l-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        ...
        <div className="flex flex-col justify-between items-center lg:flex-row">
          <a
            href="#"
            className="flex items-center mb-6 text-2xl font-semibold text-gray-900 lg:mb-0 dark:text-white"
          >
            <svg
              className="mr-2 h-8"
              viewBox="0 0 33 33"
